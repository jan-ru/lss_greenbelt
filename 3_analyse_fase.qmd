...
Om de vraag te beantwoorden wordt een histogram geplot en wordt een statistiche toets gedaan. De variabele met de meeste impact is vervolgens de variabele met de grootste afwijking.
...
Om te bepalen of het gemiddelde van blok 1 (55,5) significant verschillend is van het gemiddelde van blok 2 (50.7) voeren we een dubbelzijdige (onafhankelijke) t-test uit. (zie: @as2013BasisboekKwantitatieveMethoden). De nul hypothese is dat de gevonden steekproef gemiddeldes statistisch gelijk zijn. Ofwel:
...
Dat wil zeggen: komen de 5 steekproeven waarschijnlijk uit dezelfde populatie of zijn ze wezenlijk anders? Meer specifiek: is de gemiddelde duur om de e-learning af te ronden significant verschillend? Is de variatie significant verschillend?

Om de vragen te beantwoorden wordt een histogram van de vijf verdelingen geplot en wordt een (onafhankelijke) t-test uitgevoerd met een 95% betrouwbaarheids interval.
